...
def run_batch_evaluation(
    ...
    *,
    ...
    """
    Run evaluate_response over a batch of test cases.
    Each test case must have: query, answer, contexts (list of str).
    Returns a list of result dicts with scores added.
    """
    api_key = api_key or os.environ.get("GROQ_API_KEY", "")
    results = []
